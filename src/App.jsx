...
const TRAVEL_PLACES = [
  {
    ...
    places: [
      ...
      { name: "Glasgow", lat: 55.8642, lng: -4.2518, note: "A solo trip after a long month, and exactly the much-needed me time I needed. I also saw some very cool Highland cows." },
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Las Vegas", lat: 36.1699, lng: -115.1398, note: "Saw the retirement fight of Nate Diaz and definitely did not lose money." },
  ...
  { country: "Macau SAR", code: "MO", places: [{ name: "Macau", lat: 22.1987, lng: 113.5439, note: "I also visited Macau when I was young. One of the clearest impressions I retained was how expensive and extravagant parts of it felt." }] },
  {
    ...
    code: "IN",
    places: [
      { name: "Hoshiarpur", lat: 31.5324, lng: 75.9172, note: "Where my dad grew up and where my grandparents live. I love visiting because it feels like a second home." },
      { name: "Dhariwal", lat: 31.9552, lng: 75.3235, note: "Where all the cousins meet and hang out. My Nanaji treated me like a king." },
      { name: "Amritsar", lat: 31.634, lng: 74.8723, note: "Some of the most amazing food I have ever had, and the Golden Temple is unforgettable." },
      { name: "Agra", lat: 27.1767, lng: 78.0081, note: "I came just for the Taj Mahal, and it blew me away. Pictures do not do it justice. I also got chased by a monkey." },
